...
if (!/"APP_VERSION"\s*:\s*"1\.2\.0"/.test(wrangler)) throw new Error("wrangler APP_VERSION does not match package version");
...
if (!/APP_VERSION\s*=\s*"1\.2\.0"/.test(config)) throw new Error("Runtime APP_VERSION does not match package version");
...
console.log("VALIDATION PASS: V1.2.0 architecture, migrations, version consistency, pinned tooling, secret scan, native setup, zero runtime dependencies, syntax");
