...
const required=["package.json","wrangler.jsonc","src/index.js","src/router.js","src/security.js","src/db.js","src/ui.js","src/client.js","src/utils.js"];
for(const f of required)if(!fs.existsSync(path.join(root,f)))throw new Error(`Missing ${f}`);
const pkg=JSON.parse(fs.readFileSync(path.join(root,"package.json"),"utf8"));
if(pkg.version!=="1.1.0")throw new Error("Unexpected version");
